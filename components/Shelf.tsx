...
import {
  DENSITY_OPTIONS, MOTION_OPTIONS, TONE_OPTIONS, useSettings,
        ...
        <div className="wos shelf-panel">
          ...
          <div style={{ marginBottom: 12 }}>
            ...
            <div style={{ display: "flex", gap: 6 }}>
              {TONE_OPTIONS.map((t) => (
                <button key={t} onClick={() => setOne("tone", t)}
                  style={{
          ...
          <RadioRow<Density> label="density" value={settings.density} options={DENSITY_OPTIONS} onChange={(v) => setOne("density", v)} />
          <RadioRow<Motion>  label="motion"  value={settings.motion}  options={MOTION_OPTIONS}  onChange={(v) => setOne("motion", v)} />

          <div className="ascii-rule" style={{ marginTop: 12, color: "var(--ink-faint)", fontSize: 10 }}>
            ============================
          </div>
          <div className="micro" style={{ marginTop: 12, color: "var(--ink-faint)", lineHeight: 1.5 }}>
